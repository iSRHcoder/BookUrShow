...
export const getMovieList = (page = 1) => {
  return fetch(
    `https://api.themoviedb.org/3/discover/movie?api_key=a9b9fc20b24e7aac267be09f72d57e26&page=${page}&with_original_language=hi&primary_release_year=2023&region=IN`
  ).then((res) => res.json());
};
